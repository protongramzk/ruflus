  ...
  return (
    <div className="flex flex-col space-y-4 pb-24">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-xl font-black text-black uppercase tracking-tight">{t.bills}</h1>
          <p className="text-xs text-gray-400 font-bold">{t.billsSub}</p>
        </div>
      </div>
      ...
      <div className="flex border border-black p-1 bg-gray-50">
        ...
        >
          {t.unpaidBills} ({unpaidBills.length})
        </button>
        <button
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-[10px] text-green-600 font-bold mt-0.5 font-bold uppercase tracking-widest">
                          LUNAS • {bill.dueDate}
                        </p>
                      </div>
      ...
      {/* Add Modal */}
      <Modal isOpen={isAddOpen} onClose={() => setIsAddOpen(false)} title={t.addBillTitle}>
        <BillForm
